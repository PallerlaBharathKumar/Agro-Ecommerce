...
if Mode =='Team':
    ...
    st.image(os.path.join('./images','Subramanian.jpeg'),width=200)
    st.markdown("""
    <style>
            #id2{
    ...
    <a  href="https://www.linkedin.com/in/bala-subramanian-15ba9940"  target="_blank"><button id="id2">Dr.C.Bala Subramanian</button></a>
    ...
    st.image(os.path.join('./images','Bharath.jpeg'),width=200)
    st.markdown("""
    <style>
            #id2{
            background-color: Dodgerblue;
    ...
    st.image(os.path.join('./images','sumanth.jpeg'),width=200)
    st.markdown("""
    <style>
            #id2{
            background-color: Dodgerblue;
    ...
    <a  href="https://www.linkedin.com/in/sumanth-reddy-380660238"  target="_blank"><button id="id2">V.Sai Sumanth</button></a>
    <p id="id3">Student, Department of  Computer Science and Engineering<br>Kalasalingam Academy of Research and Education <br>Krishnankoil, India</p>
    """,unsafe_allow_html=True)

    st.image(os.path.join('./images','Vishal.jpeg'),width=200)
    st.markdown("""
    <style>
            #id2{
            background-color: Dodgerblue;
    ...
    <a  href="https://www.linkedin.com/in/veerati-vishal-bb675b1b2"  target="_blank"><button id="id2">V.Vishal</button></a>
    <p id="id3">Student, Department of  Computer Science and Engineering<br>Kalasalingam Academy of Research and Education <br>Krishnankoil, India</p>
    """,unsafe_allow_html=True)

    st.image(os.path.join('./images','vamshi2.jpeg'),width=200)
    st.markdown("""
    <style>
            #id2{
            background-color: Dodgerblue;
    ...
    <a  href="https://www.linkedin.com/in/p-vamshi-krishna-0388791b2"  target="_blank"><button id="id2">P.Vamshi Krishna</button></a>
    <p id="id3">Student, Department of  Computer Science and Engineering<br>Kalasalingam Academy of Research and Education <br>Krishnankoil, India</p>
    """,unsafe_allow_html=True)
